...
export const metadata: Metadata = {
  title: "CorpoBonds  | Mis Bonos",
  description: "Gestión de bonos",
};

// Datos de ejemplo para los bonos 
const mockBonds = [
  {
    id: "BON-2023-001",
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-8">
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-400">
            Gestiona todos tus bonos en un solo lugar
          </p>
        </div>
        ...
        <div className="flex">
          ...
          <div className="ml-3">
            ...
            <p className="mt-2 text-sm text-blue-700 dark:text-blue-400">
              Recuerda que todos tus bonos  están protegidos bajo la normativa de la SBS. 
              Para cualquier consulta o reclamo, puedes contactar a nuestro servicio de atención al usuario 
              al correo <span className="font-medium">soporte@CorpoBonds .pe</span> o llamar al <span className="font-medium">01-456-7890</span>.
            </p>
          </div>
        </div>
      </div>
